...
fluid_dsp_float_interpolate_none (fluid_voice_t *voice)
{
  ...
  end_index = looping ? (unsigned int) (voice->loopend - 1) : (unsigned int) voice->end;
...
fluid_dsp_float_interpolate_linear (fluid_voice_t *voice)
{
  ...
  end_index = (unsigned int) ((looping ? voice->loopend - 1 : voice->end) - 1);
...
fluid_dsp_float_interpolate_7th_order (fluid_voice_t *voice)
{
  ...
  end_index = (unsigned int) (looping ? voice->loopend - 1 : voice->end) - 3;
