...
{
  chan->prognum = (unsigned int) prognum;
  return FLUID_OK;
}
...
{
  chan->channel_pressure = (short) val;
...
{
  chan->pitch_wheel_sensitivity = (short) val;
